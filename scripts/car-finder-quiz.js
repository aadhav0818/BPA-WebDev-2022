...
const btnHTML = '<button type="button" class="prev-btn btn btn-light">Back</button>';
...
function firstQuestion() {
    ...
    <div class="entry-container price-entry-container">
        <input type="number" class="entry price-entry" min="10000" max="100000" value="55000">
    </div>
    `
...
function secondQuestion() {
    ...
    <div class="entry-container mileage-entry-container">
        <input type="number" class="entry mileage-entry" min="5000" max="150000" value="77500">
    </div>
    `
...
function findCars() {
    ...
    if(maxPrice == null || maxMiles == null || bodyStyles.length == 0) {
        document.querySelector(".quiz-alert").innerHTML += 
        `
        <div class="question-alert alert alert-warning alert-dismissible fade show" role="alert" style="position:fixed; top: 3rem; width: 80%; margin-left: 10%">
          Make sure all questions are properly filled!
    ...
    document.querySelector(".car-quiz").innerHTML = "";
...
function displayMatchedVehicles(indices) {
    for(var i = 0; i < indices.length; i++) {
        ...
        <div class="col-sm-12 col-md-6 col-lg-3 " style="padding-top: 3rem;"> 
            <div class="h-100 card bg-dark text-white id-${vehicle_data[index].id}" style="width: 100%;">
                ...
                <div class="card-body">
                    ...
                    Price: $${vehicle_data[index].price}
                    </p>
    ...
    document.querySelector(".car-results-header").innerHTML += `
        <div class="card car-finder-banner" style="margin: 1rem; margin-top: 1rem; background-color: #99b8c2;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Browse our inventory to explore our collection of vehicles!</p>
