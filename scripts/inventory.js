    ...
    for(let i = 0; i < vehicle_data.length; i++)
    {
        ...
        <div class="card bg-dark text-white id-${vehicle_data[i].id}" style="width: 100%;">
            ...
            <div class="card-body">
                ...
                <a href="#" class="btn btn-outline-success btn-inventory-card" data-bs-toggle="modal" data-bs-target="#ShopModalCenter-${vehicle_data[i].id}">$ | Purchase</a>
                        ...
                        <div class="modal-footer">
                            ...
                            <a href = "contact-us.html">
                                <button type="button" class="btn btn-outline-secondary">
                                    <i class="fa-solid fa-user"></i> | Check Availability
                                </button>
                            </a>
                        </div>
                    </div>
        ...
        {   
            ...
            <div class="card bg-dark text-white id-${filtered_inventory[i].id}" style="width: 100%;">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-outline-success btn-inventory-card" data-bs-toggle="modal" data-bs-target="#ShopModalCenter-${filtered_inventory[i].id}">$ | Purchase</a>
